...
def test_perf() -> None:
    ...
    print(
        f"- time for temperature: {timeit.timeit(temperature, number=119600)}s"
    )
    ...
    print(
        f"- time for temperature de pd: {timeit.timeit(temperature_pd, number=119600)}s"
    )
    ...
    print(
        f"- time for temperature (wrong unit): {timeit.timeit(temperature_ft, number=119600)}s"
    )
    ...
    print(
        f"- time for temperature (without unit): {timeit.timeit(temperature_aero, number=119600)}s"
    )
    ...
    print(
        f"- time for pressure (wrong unit): {timeit.timeit(pressure_ft, number=18886)}s"
    )
    ...
    print(
        f"- time for tas2mach convertion: {timeit.timeit(tas2mach, number=33480)}s"
    )
    ...
    print(
        f"- time for tas2mach convertion (wrong unit): {timeit.timeit(tas2mach_si, number=33480)}s"
    )
